...
Report bugs at https://github.com/TakashiAihara/ssh-dispatch/issues
...
https://github.com/TakashiAihara/ssh-dispatch/issues.
...
Ready to contribute? Here's how to set up `ssh-dispatch` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `ssh-dispatch` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/ssh-dispatch.git
